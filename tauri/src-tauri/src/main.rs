...
pub fn run() {
    tauri::Builder::default()
        ...
        .manage(global_shortcut::GlobalShortcutState::new())
        .setup(|app| {
            #[cfg(desktop)]
            {
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            stop_audio_playback,
            global_shortcut::register_global_hotkey,
            global_shortcut::unregister_global_hotkey,
            global_shortcut::get_current_hotkey
        ])
