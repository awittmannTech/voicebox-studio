...
interface UIStore {
  ...
  // Hotkey recording pending profile creation
  pendingHotkeyRecordingId: string | null;
  setPendingHotkeyRecordingId: (id: string | null) => void;
...
export const useUIStore = create<UIStore>((set) => ({
  ...
  pendingHotkeyRecordingId: null,
  setPendingHotkeyRecordingId: (id) => set({ pendingHotkeyRecordingId: id }),
