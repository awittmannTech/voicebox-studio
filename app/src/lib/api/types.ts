...
export interface ActiveTrainingTask {
  job_id: string;
  profile_id: string;
  status: string;
  started_at: string;
...
export interface GenerationFavoriteToggle {
  is_favorite: boolean;
}

export interface GenerationNotesUpdate {
  notes?: string;
}
...
export interface TrainingJobResponse {
  id: string;
  profile_id: string;
  status: 'pending' | 'preparing_data' | 'training' | 'completed' | 'failed' | 'cancelled';
  progress: number;
