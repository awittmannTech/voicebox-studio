...
import { HotkeyRecordingsTab } from '@/components/HotkeyRecording/HotkeyRecordingsTab';
...
// Hotkey recordings route
const hotkeyRecordingsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: '/hotkey-recordings',
  component: HotkeyRecordingsTab,
});
