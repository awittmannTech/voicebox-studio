...
def ensure_qwen_tts():
    """Install qwen-tts from git if not already installed."""
    try:
        importlib.metadata.distribution("qwen-tts")
        print("qwen-tts is already installed")
    except importlib.metadata.PackageNotFoundError:
        print("qwen-tts not found, installing from git...")
...
def build_server():
    ...
    # Ensure qwen-tts is installed before building
    ensure_qwen_tts()
